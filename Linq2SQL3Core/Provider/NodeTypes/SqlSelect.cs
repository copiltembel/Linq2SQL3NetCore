...
namespace System.Data.Linq.Provider.NodeTypes
{
    internal class SqlSelect : SqlStatement
    {
        ...
        private List<SqlLoadWithExpression> loadWith;
            ...
            : base(SqlNodeType.Select, sourceExpression)
        {
            ...
            this.loadWith = new List<SqlLoadWithExpression>();
        }
        ...
        internal List<SqlLoadWithExpression> LoadWith
        {
            get { return this.LoadWith; }
        }
    }
}